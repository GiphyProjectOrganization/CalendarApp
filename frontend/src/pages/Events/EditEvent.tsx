    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-primary/10 via-secondary/10 to-accent/10 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-base-content mb-4">Please log in to edit events</p>
          <button 
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-primary/10 via-secondary/10 to-accent/10 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-base-content mb-4">The event you're trying to edit doesn't exist</p>
          <button 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <PlacePicker
                  ...
                  initialAddress={typeof event.location === 'object' ? event.location.address : event.location}
                  lat={location.lat}
                  lon={location.lon}
                />
                <div className="text-xs text-base-content/60 mt-1">
              ...
              <div className="bg-base-200 p-4 rounded-lg space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <select
                      value={event.recurrencePattern?.type || ''}
